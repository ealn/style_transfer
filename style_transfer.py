...
def get_list_files():
    ...
    for file in os.listdir("imgs"):
        if os.path.isfile("imgs" + "/" + file):
            list_imgs.append("imgs" + "/" + file)

    for file in os.listdir("styles"):
        if os.path.isfile("styles" + "/" + file):
            list_styles.append("styles" + "/" + file)

    return list_imgs, list_styles

def main():
    list_imgs, list_styles = get_list_files()
    proccess(list_imgs, list_styles)
